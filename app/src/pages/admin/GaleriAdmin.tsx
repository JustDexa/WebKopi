    ...
    <div className="min-h-screen bg-[#FCFAF8] p-6 md:p-12 relative">
      ...
      {deleteModalId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-7 shadow-2xl max-w-sm w-full transform transition-all scale-100">
            <h3 className="text-xl font-bold text-[#3A261D] mb-2">Hapus Foto?</h3>
            <p className="text-[#7A6A5E] text-sm mb-6">
              Tindakan ini tidak bisa dibatalkan. Foto akan dihapus secara permanen dari galeri Anda.
            </p>
      ...
      <div className="max-w-[1200px] mx-auto">
        <header className="mb-10">
          ...
          <p className="text-[#7A6A5E] mt-2">Tambahkan foto baru atau kelola foto yang sudah ada di galeri.</p>
        </header>
              ...
              <form onSubmit={handleUpload} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Contoh: Panen kopi robusta"
                  />
                </div>
          ...
          <div className="lg:col-span-8">
            {loading ? (
              <div className="flex justify-center items-center h-60">
                <p className="text-[#6B5B4F] font-medium animate-pulse">Memuat galeri...</p>
              </div>
            ) : images.length === 0 ? (
              <div className="bg-white border border-dashed border-[#E1D7CE] rounded-2xl p-12 text-center">
                <p className="text-[#7A6A5E]">Belum ada foto di galeri.</p>
              </div>
            ) : (
